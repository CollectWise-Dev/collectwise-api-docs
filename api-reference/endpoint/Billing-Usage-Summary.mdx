...
You can mix formats (e.g., date-only for start, ISO timestamp for end). Stripe meters are accurate to the hour.
...
- Costs reflect your organization's subscription pricing when available, otherwise standard rates are used
