...
The `rpc` field indicates whether right-party contact (identity verification) was completed during the call:

- `true` - The right party was verified during the call
- `false` - Verification was attempted but not completed
- `null` - The integration does not report verification

This field supports compliance workflows (e.g., call-frequency rules) that depend on whether the right party was reached.
