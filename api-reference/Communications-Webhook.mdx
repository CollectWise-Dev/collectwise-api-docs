...
This webhook reports that a communication occurred; it does not include the message body. To receive the text of a consumer's reply to a message you sent, use the [Inbound Reply webhook](/api-reference/Inbound-Reply-Webhook) instead.
