...
Text requests share your organization-wide allowance with other authenticated API routes: a token bucket refilling at 50 requests per second with a 3,000-request burst. See [API Access](/authorization#organization-wide-request-allowance) for 429 responses, headers and retry guidance.
