...
Register an [Inbound Reply Webhook](/api-reference/Inbound-Reply-Webhook) to have every reply pushed to you as it arrives, or read the thread on demand with [List Text Messages](/api-reference/endpoint/Text-Messages).
