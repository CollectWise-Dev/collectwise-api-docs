...
The previous text-specific request limits are removed with the API security rollout. API-wide request allowances are managed by CollectWise and will be documented when enabled. See [API Access](/authorization) for authentication and optional security controls.
