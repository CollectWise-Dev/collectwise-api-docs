...
Text requests share your organization-wide allowance with other authenticated API routes: 50 requests per second with bursts of up to 3,000 requests when capacity is available. See [API Access](/authorization#organization-wide-request-allowance) for 429 responses, headers and retry guidance.
